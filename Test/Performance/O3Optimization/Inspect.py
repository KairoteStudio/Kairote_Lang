...
def main():
    ...
    assert report["completed"] and all(report["correctness"].values())
    ...
    mapping = {"Fib35":"Recur", "Fib40":"Recur", "TailSum":"Sum", "Product":"Product",
               ...
               "IntegerLoop":"Kernel", "ExpandedLoop":"Kernel", "HelperLoop":"Kernel"}
    ...
    for name, function in mapping.items():
        ...
        for variant in ("Before", "O2", "O3", "Gcc"):
    ...
    print(f"Verified all measured binaries, {count} samples, identical Fib35/40 bodies.")
